...
FormatRegistry.Set('display-id', value => IsDisplayId(value));
FormatRegistry.Set('android-unique-id', value => IsAndroidUniqueID(value));
...
function IsDisplayId(value: string) {
  return value.length === 12 && DISPLAY_ID.test(value);
}
function IsAndroidUniqueID(value: string) {
